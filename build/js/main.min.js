...
var _initSliderCoaches = require("./modules/init-slider-coaches");
var _initSliderReviews = require("./modules/init-slider-reviews");
// ---------------------------------
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":5,"./modules/init-slider-coaches":11,"./modules/init-slider-reviews":12,"./modules/init-video-player":13,"./modules/modals/init-modals":14,"./modules/tabs/init-tabs":16,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
var buttonNext = document.querySelector('.coaches__button--next');
var buttonPrev = document.querySelector('.coaches__button--prev');
...
var cover = document.querySelector('.about__video').querySelector('img');
var button = document.querySelector('.about__video').querySelector('button');
...
},{"./tabs":17}],17:[function(require,module,exports){
"use strict";
